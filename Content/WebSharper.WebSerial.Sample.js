...
(function(Global)
{
 ...
 WebSharper$WebSerial$Sample_Templates=Global.WebSharper$WebSerial$Sample_Templates=Global.WebSharper$WebSerial$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_WebSerial_Sample$Client=Global.StartupCode$WebSharper_WebSerial_Sample$Client||{};
 ...
 {
  var _,b,_this,t,p,i;
  _=(b=(_this=(t=new ProviderBuilder.New$1(),(t.h.push(Handler.EventQ2(t.k,"connectandsend",function()
  {
   return t.i;
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(Client.connectAndSend()),function()
    {
     return Concurrency.Return(null);
    });
   })),null);
  })),t)),(_this.h.push(new TextView.New("status",Client.statusMessage().get_View())),_this)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$WebSerial$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.connectAndSend=function()
 {
  var _;
  function f()
  {
   function f$1()
   {
    return Client.serial().requestPort().then(function(a)
    {
     return a.open({
      baudRate:9600
     }).then(function()
     {
      ...
      return Promise.OfAsync(Promise.AsAsync(writer.write(Global["eval"]("new TextEncoder()").encode("Hello\n")))).then(function()
      {
       writer.releaseLock();
       Client.statusMessage().Set("Message Sent!");
   ...
   function f$2(a)
   {
    Client.statusMessage().Set("Error: "+Global.String(a.message));
    return Promise$1.resolve(null);
   }
 ...
 WebSharper$WebSerial$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.port=Var$1.Create$1(void 0);
  SC$1.serial=self.navigator.serial;
  SC$1.statusMessage=Var$1.Create$1("Waiting...");
 };
