...
function b(){ const fV=new n("New_1");const fW=(fV.h.push(q(fV.k, "connectandsend", () => fV.i, () => { const f2=null;N(K(() => L(W(d()), () => M(null))), null);})),fV);const fX=(fW.h.push(new F("status", c().View)),fW);const fY=r(fX.k, fX.h, []);const fZ=new i(fY[1], D(fY[0]));let f0=(fX.i=fZ,fZ);const f1=f0.Doc;u0032("");bj.RunById("main", f1);}
function c(){ return G.statusMessage;}
function d(){ const fV=null;return new Promise((fW) => { fW(new Promise((fX) => { fX(globalThis.navigator.serial.requestPort().then((fY) => fY.open({baudRate:9600}).then(() => { const fZ=fY.writable.getWriter();return Y(W(fZ.write(eval("new TextEncoder()").encode("Hello\n")))).then(() => { fZ.releaseLock();c().Set("Message Sent!");return Promise.resolve(null);});})));})["catch"]((fX) => { const fY=X(fX);c().Set("Error: "+String(fY.message));return Promise.resolve(null);}));});}
...
class n extends h { i;k;h;s;static New_1(){ return new this("New_1");} constructor(fV){ if(fV=="New_1"){ let fW;super();this.i=null;this.k=(fW=H(),String(fW));this.h=fN([]);fO(this, "s", null);} } }
...
function r(fV, fW, fX){ const fY=new bk("New_5");const fZ=new br("New_3");const f0=cz(fW);try { while(f0.MoveNext()){ const f1=f0.Current;const f2=f1.Name;fZ.SAdd(f2);fY.set_Item(f2, f1);} } finally { if(typeof f0=="object"&&a(f0))f0.Dispose();} return[bs(fW, bH((f3) => { const f4=f3[0];const f5=f3[1];const f6=f3[2];if(fZ.Contains(f4))return null;else { const f7=f5===0?bW.GetOrAddHoleFor(fV, f4, () => { const f8=f6==null?null:u0031(f6.$0);let f9=bl.Create_1(f8==null?"":f8.$0);return new bX(f4, f9);}):f5===1?bW.GetOrAddHoleFor(fV, f4, () => { const f8=f6==null?null:u0031(f6.$0);let f9=bl.Create_1(f8==null?0:f8.$0);return new bY(f4, f9);}):f5===2?bW.GetOrAddHoleFor(fV, f4, () => { const f8=f6==null?null:u0031(f6.$0);let f9=bl.Create_1(f8==null?false:f8.$0);return new bZ(f4, f9);}):f5===3?bW.GetOrAddHoleFor(fV, f4, () => { const f8=f6==null?null:u0031(f6.$0);let f9=bl.Create_1(f8==null?-8640000000000000:f8.$0);return new b0(f4, f9);}):f5===4?bW.GetOrAddHoleFor(fV, f4, () => new b1(f4, bl.Create_1([]))):f5===5?bW.GetOrAddHoleFor(fV, f4, () => new b2(f4, bl.Create_1(u0031(globalThis.document.querySelector("[ws-dom="+f4+"]"))))):f5===6?bW.GetOrAddHoleFor(fV, f4, () => { const f8=f6==null?null:u0031(f6.$0);let f9=bl.Create_1(f8==null?[]:f8.$0);return new b3(f4, f9);}):e("Invalid value type");fY.set_Item(f4, f7);return u0031(f7);} }, fX)), {$:0, $0:fY}];}
function s(fV, fW){ if(fV===fW)return true;else { const fX=typeof fV;if(fX=="object"){ if(fV===null||fV===void 0||fW===null||fW===void 0||!s(typeof fW, "object"))return false;else if("Equals"in fV)return fV.Equals(fW);else if("Equals"in fW)return false;else if(fV instanceof Array&&fW instanceof Array)return t(fV, fW);else if(fV instanceof Date&&fW instanceof Date)return u(fV, fW);else { const fY=[true];let fZ;for(var f1 in fV)if(((f2) => { fY[0]=!fV.hasOwnProperty(f2)||fW.hasOwnProperty(f2)&&s(fV[f2], fW[f2]);return!fY[0];})(f1))break;if(fY[0]){ let f0;for(var f2 in fW)if(((f3) => { fY[0]=!fW.hasOwnProperty(f3)||fV.hasOwnProperty(f3);return!fY[0];})(f2))break;} return fY[0];} } else return fX=="function"&&("$Func"in fV?fV.$Func===fW.$Func&&fV.$Target===fW.$Target:"$Invokes"in fV&&"$Invokes"in fW&&t(fV.$Invokes, fW.$Invokes));} }
...
function D(fV){ u0032("index");return fV?u0033("index", u0031("main"), fV):void 0;}
...
function J(fV){ const fW={};const fX=cz(fV);try { while(fX.MoveNext()){ const fY=fX.Current;fW[fY[0]]=fY[1];} } finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} return fW;}
...
function bd(fV, fW){ let fX;const fY=[];const fZ=[];const f0=[];const f1=[];const f2=new bk("New_5");const f3=cz(fW);try { while(f3.MoveNext()){ const f4=f3.Current;f2.set_Item(f4.Name, f4);} } finally { if(typeof f3=="object"&&a(f3))f3.Dispose();} let f5=dp(fV);const f6=(gd, ge) => { const gf=dO(gd, ge);fZ.push(dP(gf));f0.push([gd, gf]);const gg=fQ(gf.OnAfterRender);if(gg==null)return null;else { const gh=gg.$0;f1.push(() => { gh(gd);});return;} };const f7=(gd) => { let ge;const gf=(ge=null,[f2.TryGetValue(gd, {get:() => ge, set:(gi) => { ge=gi;}}), ge]);if(gf[0]){ const gg=gf[1];if(gg instanceof d5)return u0031(gg.Value);else if(gg instanceof E)return u0031(bj.TextNode(gg.Value));else { const gh=gg.ForTextView();return gh==null?null:u0031(bj.TextView(gh.$0));} } else return null;};bf(fV, "[ws-hole]", (gd) => { const ge=gd.getAttribute("ws-hole");gd.removeAttribute("ws-hole");while(gd.hasChildNodes())gd.removeChild(gd.lastChild);const gf=f7(ge);if(gf!=null&&gf.$==1){ const gg=gf.$0;cF(gd, gg.docNode);fY.push(cZ.New(dQ(gd), gg.docNode, null, gd, c0(), null));fZ.push(gg.updates);} });bf(fV, "[ws-replace]", (gd) => { const ge=f7(gd.getAttribute("ws-replace"));if(ge!=null&&ge.$==1){ const gf=ge.$0;const gg=gd.parentNode;const gh=globalThis.document.createTextNode("");gg.replaceChild(gh, gd);const gi=cK(gh, gf.docNode);f5=dp(fV);const gj=bI((gk) => gd===gk, f5);if(gj==null){ } else k(f5, gj.$0, gf.docNode);fY.push(cZ.New(dQ(gg), gf.docNode, u0031([gi, gh]), gg, c0(), null));fZ.push(gf.updates);} });let f8=false;bf(fV, "slot", (gd) => { const ge=gd.getAttribute("name");const gf=ge==""||ge==null?"default":ge.toLowerCase();if(f8&&gf=="default"||!s(fV.parentElement, null)){ } else { while(gd.hasChildNodes())gd.removeChild(gd.lastChild);if(gf=="default")f8=true;const gg=f7(gf);if(gg!=null&&gg.$==1){ const gh=gg.$0;cF(gd, gh.docNode);fY.push(cZ.New(dQ(gd), gh.docNode, null, gd, c0(), null));fZ.push(gh.updates);} } });bf(fV, "[ws-attr]", (gd) => { let ge;const gf=gd.getAttribute("ws-attr");gd.removeAttribute("ws-attr");const gg=(ge=null,[f2.TryGetValue(gf, {get:() => ge, set:(gi) => { ge=gi;}}), ge]);if(gg[0]){ const gh=gg[1];if(gh instanceof d6)f6(gd, gh.Value);else console.warn("Attribute hole filled with non-attribute data", gf);} });bf(fV, "[ws-on]", (gd) => { f6(gd, eh.Concat(bH((ge) => { let gf;const gg=eo(ge, [":"], 1);const gh=(gf=null,[f2.TryGetValue(j(gg, 1), {get:() => gf, set:(gj) => { gf=gj;}}), gf]);if(gh[0]){ const gi=gh[1];return gi instanceof d7?u0031(d8(j(gg, 0), gi.Value)):gi instanceof I?u0031(eh.Handler(j(gg, 0), gi.Value)):(console.warn("Event hole on"+j(gg, 0)+" filled with non-event data", j(gg, 1)),null);} else return null;}, eo(gd.getAttribute("ws-on"), [" "], 1))));gd.removeAttribute("ws-on");});bf(fV, "[ws-onafterrender]", (gd) => { let ge;const gf=gd.getAttribute("ws-onafterrender");const gg=(ge=null,[f2.TryGetValue(gf, {get:() => ge, set:(gi) => { ge=gi;}}), ge]);if(gg[0]){ const gh=gg[1];if(gh instanceof ei){ gd.removeAttribute("ws-onafterrender");f6(gd, d9(gh.Value));} else if(gh instanceof ej){ gd.removeAttribute("ws-onafterrender");f6(gd, d9(gh.Value));} else console.warn("onafterrender hole filled with non-onafterrender data", gf);} });bf(fV, "[ws-var]", (gd) => { let ge;const gf=gd.getAttribute("ws-var");gd.removeAttribute("ws-var");const gg=(ge=null,[f2.TryGetValue(gf, {get:() => ge, set:(gh) => { ge=gh;}}), ge]);if(gg[0])gg[1].AddAttribute((gh) =>(gi) => f6(gh, gi), gd);});const f9=() => { bh("[ws-dom]", (gd) => { let ge;let gf;let gg;const gh=(ge=null,[f2.TryGetValue(gd.getAttribute("ws-dom").toLowerCase(), {get:() => ge, set:(gl) => { ge=gl;}}), ge]);if(gh[0]){ const gi=gh[1];if(gi instanceof b2){ const gj=gi.Value;gd.removeAttribute("ws-dom");gf=gd;const gk=new MutationObserver((gl, gm) => { bM((gn) => { gn.removedNodes.forEach(fR((go) => go[0]===gf&&gn.addedNodes.length!==1?(gj.SetFinal(null),gm.disconnect()):null), null);}, gl);});if(gd.parentElement!==null)gk.observe(gd.parentElement, (gg={},gg.childList=true,gg));gj.Set(u0031(gd));c_((gl) => { if(gl!=null&&gl.$==1){ const gm=gl.$0;if(gf===gm){ } else { gf.replaceWith(gm);gf=gm;} } else { gf.remove();gk.disconnect();} }, gj.View);} } });};bf(fV, "[ws-attr-holes]", (gd) => { const ge=new RegExp(bi(), "g");const gf=eo(gd.getAttribute("ws-attr-holes"), [" "], 1);gd.removeAttribute("ws-attr-holes");for(let gg=0, gh=gf.length-1;gg<=gh;gg++)((() => { let gi;const gj=j(gf, gg);const gk=gd.getAttribute(gj);let gl=null;let gm=0;const gn=[];while(gl=ge.exec(gk),gl!==null){ const go=dn(gk, u0031(gm), u0031(ge.lastIndex-j(gl, 0).length-1));gm=ge.lastIndex;gn.push([go, j(gl, 1)]);} const gp=dn(gk, u0031(gm), null);ge.lastIndex=0;const gq=bN((gv, gw) =>(((gx) => { const gy=gx[0];const gz=gx[1];return(gA) => { let gB;const gC=gA[0];const gD=gA[1];const gE=(gB=null,[f2.TryGetValue(gz, {get:() => gB, set:(gG) => { gB=gG;}}), gB]);const gF=gE[0]?gE[1].AsChoiceView:ek("");return gF.$==1?[gy, em.Cons(gC==""?gF.$0:c$((gG) => gG+gC, gF.$0), gD)]:[gy+gF.$0+gC, gD];};})(gv))(gw), gn, [gp, em.Empty]);if(gq[1].$==1){ if(gq[1].$1.$==1){ if(gq[1].$1.$1.$==1){ if(gq[1].$1.$1.$1.$==0){ const gr=gq[0];gi=d_(gj, da((gv, gw, gx) => gr+gv+gw+gx, gq[1].$0, gq[1].$1.$0, gq[1].$1.$1.$0));} else { const gs=gq[0];gi=d_(gj, c$((gv) => gs+en("", gv), db(gq[1])));} } else { const gt=gq[0];gi=d_(gj, dc((gv, gw) => gt+gv+gw, gq[1].$0, gq[1].$1.$0));} } else if(gq[0]=="")gi=d_(gj, gq[1].$0);else { const gu=gq[0];gi=d_(gj, c$((gv) => gu+gv, gq[1].$0));} } else gi=eh.Create(gj, gq[0]);return f6(gd, gi);})());});let f_=f5;const f$=f1.length==0?u0031(() => { f9();}):u0031((gd) => { f9();bM((ge) => { ge(gd);}, f1);});const ga=!s(f5, null)&&f5.length===1&&(j(f5, 0)instanceof Node&&(j(f5, 0)instanceof Element&&(fX=j(f5, 0),true)))?u0031(fX):null;let gb={Els:f_, Dirty:true, Holes:fY, Attrs:f0, Render:f$?f$.$0:void 0, El:ga?ga.$0:void 0};let gc=fS(gb, ["Render", "El"]);return[gc, ev(c9(), dd, fZ)];}
...
function bt(fV){ const fW=cz(fV);try { return fW.MoveNext()?fW.Current:dz();} finally { if(typeof fW=="object"&&a(fW))fW.Dispose();} }
function bu(fV, fW, fX){ let fY=fW;const fZ=cz(fX);try { while(fZ.MoveNext())fY=fV(fY, fZ.Current);return fY;} finally { if(typeof fZ=="object"&&a(fZ))fZ.Dispose();} }
function bv(fV, fW){ const fX=cz(fW);try { while(fX.MoveNext())fV(fX.Current);} finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} }
...
function bG(fV, fW){ const fX=cz(fW);try { let fY=false;while(!fY&&fX.MoveNext())fY=fV(fX.Current);return fY;} finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} }
...
function bK(fV, fW){ let fX=false;let fY=0;while(!fX&&fY<m(fW))if(fV(fW[fY]))fX=true;else fY=fY+1;return fX;}
...
function bQ(fV){ if(fV instanceof Array)return fV.slice();else if(fV instanceof em)return bS(fV);else { const fW=[];const fX=cz(fV);try { while(fX.MoveNext())fW.push(fX.Current);return fW;} finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} } }
...
function bT(fV, fW){ let fX=true;let fY=0;while(fX&&fY<m(fW))if(fV(fW[fY]))fY=fY+1;else fX=false;return fX;}
...
function b_(fV, fW, fX){ const fY=fV.s;if(fY==null)fX();else fY!=null&&fY.$==2?(fY.$1.push(fX),fW(fY.$0)):fY!=null&&fY.$==3?(fY.$0.push(fW),fY.$1.push(fX)):fW(fY.$0);}
...
function cf(fV, fW){ const fX=fV.s;if(fX==null)fW();else fX!=null&&fX.$==2?fX.$1.push(fW):fX!=null&&fX.$==3?fX.$1.push(fW):void 0;}
function cg(fV, fW, fX){ const fY=fV.s;if(fY==null)dN(fX);else fY!=null&&fY.$==2?(cu(fY.$1, fX),fW(fY.$0)):fY!=null&&fY.$==3?(fY.$0.push(fW),cu(fY.$1, fX)):fW(fY.$0);}
...
function cp(fV, fW){ const fX=fV.s;if(fX!=null&&fX.$==3){ fV.s=c4(fW);const fY=fX.$0;for(let fZ=0, f0=m(fY)-1;fZ<=f0;fZ++)(j(fY, fZ))(fW);} else void 0;}
function cq(fV, fW){ const fX=fV.s;if(fX!=null&&fX.$==3){ fV.s=c3(fW, fX.$1);const fY=fX.$0;for(let fZ=0, f0=m(fY)-1;fZ<=f0;fZ++)(j(fY, fZ))(fW);} else void 0;}
function cr(fV, fW, fX){ return b$((fY) => fV(fW, fY), fX);}
function cs(fV, fW, fX){ return b$((fY) => fV(fY, fW), fX);}
function ct(fV, fW){ const fX=fV.s;if(fX==null)dN(fW);else fX!=null&&fX.$==2?cu(fX.$1, fW):fX!=null&&fX.$==3?cu(fX.$1, fW):void 0;}
...
function cY(fV){ const fW=fV.El;function fX(f1, f2){ while(true){ if(f1!=null&&f1.$==1)return f1.$0.El;else if(f1!=null&&f1.$==2){ const f3=f1.$0;if(f3.Dirty){ f3.Dirty=false;return cG(fW, f3.Current, f2);} else f1=f3.Current;} else if(f1==null)return f2;else if(f1!=null&&f1.$==4)return f1.$0.Text;else if(f1!=null&&f1.$==5)return f1.$0;else if(f1!=null&&f1.$==6){ const f4=f1.$0;if(f4.Dirty)f4.Dirty=false;return bN((f7, f8) => f7==null||f7.constructor===Object?fX(f7, f8):f7, f4.Els, f2);} else { const f5=f1.$1;const f6=f1.$0;f1=f6;f2=fX(f5, f2);} } } const fY=fV.El;fA((f1) => { dy(fY, f1);}, fz(fB(fV), fy(fV.El, fQ(fV.Delimiters))));let fZ=fV.Children;const f0=fQ(fV.Delimiters);fX(fZ, f0!=null&&f0.$==1?f0.$0[1]:null);}
...
class c8 extends bj { docNode_1;updates_1;elt;rvUpdates;static TreeNode(fV, fW){ const fX=ey.Create(fW);const fY=bO((f1) => dP(f1[1]), fV.Attrs);let fZ=ev(c9(), dd, fY);let f0=dd(fZ, fX.v);return new c8(b4(fV), f0, j(fV.Els, 0), fX);} constructor(fV, fW, fX, fY){ super(fV, fW);this.docNode_1=fV;this.updates_1=fW;this.elt=fX;this.rvUpdates=fY;} }
...
function dA(fV, fW){ let fX=true;let fY=0;while(fX&&fY<m(fW))if(s(fW[fY], fV))fX=false;else fY=fY+1;return!fX;}
...
function ex(fV){ if(fV instanceof Array)return fV;else if(fV instanceof em)return bS(fV);else if(fV===null)return[];else { const fW=[];const fX=cz(fV);try { while(fX.MoveNext())fW.push(fX.Current);return fW;} finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} } }
...
function fy(fV, fW){ let fX;if(fW!=null&&fW.$==1){ const fY=[];fX=fW.$0[0].nextSibling;while(fX!==fW.$0[1]){ fY.push(fX);fX=fX.nextSibling;} return fC(fY);} else { let fZ=fV.childNodes.length;const f0=fV.childNodes;let f1=bV(fZ, (f2) => f0[f2]);return fC(f1);} }
